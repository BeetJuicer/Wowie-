...
public class PlayerData : ScriptableObject
{
    ...
    public float wallClimbDuration = 2f;
    ...
    public Vector2 ledgeHeightBoxSize= new Vector2(.7f, 1f);
    ...
    public float wallGrabMultiplier = 0.005f;
    public float wallClimbMultiplier = 0.05f;
