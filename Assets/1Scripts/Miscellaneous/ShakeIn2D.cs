...
//{
    ...
    {
        public static ShakeIn2D instance;
    ...
    public IEnumerator ShakeForSeconds(float shake_duration)
    {
        enabled = true;
    ...
    public void Shake(float shake_duration)
    {
        StopAllCoroutines();
        StartCoroutine(ShakeForSeconds(shake_duration));
    }
}
//}
